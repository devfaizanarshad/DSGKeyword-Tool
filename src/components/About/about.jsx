...
import AirManImag from "../../assets/airplan.png";
import emojy from "../../assets/emojy.png";
import seoMan from "../../assets/seoman.png";
    ...
    <main className="  mx-auto  flex  items-center flex-col lg:space-y-4 relative w-full   bg-slate-50">
      ...
      <section className="bg-gradient-to-br  mx-auto  flex  items-center flex-col mb-28   from-[#361b68] to-[#31176381]">
        ...
        <span className="pt-20 relative w-full   space-y-10  ">
          ...
          <span className="fit">
            {/* Content */}
            <h1 className="lg:text-7xl text-5xl w-[100%] max-md:pl-8   lg:pl-28 p-9 max-md:p-5 text-white  relative z-10  uppercase font-extrabold  ">
              About Us
            </h1>
          </span>
            ...
            <span className="flex justify-between max-lg:flex-col max-lg:px-14 max-sm:px-4  gap-12 items-center">
              ...
              <span>
                <motion.h3
                  ...
                  className="lg:text-5xl text-4xl lg:w-[80%]  my-5 font-extrabold "
                >
                  Working Hard to Make
                  <span className="text-yellow-500 "> SEO Easy.</span> Together
                </motion.h3>
                <motion.p
                  initial={{ opacity: 0, y: -40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: 0.8 }}
                  className="font-medium  text-gray-900  pb-10 lg:w-[70%] "
                >
